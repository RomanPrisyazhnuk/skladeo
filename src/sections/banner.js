      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            <Heading as="h1">
              Skladeo - Современное хранилище вещей
            </Heading>
            <Text as="p">
              Skladeo - это склад индивидуального хранения. После оформления вашего склада, Вы пользуетесь им самостоятельно, в любое удобное время посещая его и самостоятельно перемещая вещи.
            </Text>
